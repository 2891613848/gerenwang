export const NavBar = {
  ...
  data() { return { menuOpen: false, scrolled: false, onScroll: null } },
  methods: { toggleMenu() { this.menuOpen = !this.menuOpen }, closeMenu() { this.menuOpen = false } },
  mounted() { this.onScroll = () => { this.scrolled = window.scrollY > 10; }; window.addEventListener('scroll', this.onScroll); },
